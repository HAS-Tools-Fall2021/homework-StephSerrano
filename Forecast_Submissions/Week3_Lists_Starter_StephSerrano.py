...
for i in range(len(flow)):
        if flow [i] > 240 and month[i] == 9 and year[i] == 2021:
                ilist.append(i)

print(len(ilist))

# Q3 (include the month with the year)

ilist = []

for i in range(len(flow)):
        if flow [i] > 240 and month[i] == 9 and year[i] < 2000:
                ilist.append(i)
...
for i in range(len(flow)):
        if flow [i] > 240 and month[i] == 9 and year[i] > 2010:
                ilist.append(i)
...
# Add the == 2010 value to the > 2010 value

# Looking at the solutions, my way is not as efficient
# It also shows that I am not doing well with lists
